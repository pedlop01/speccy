...
int dataPin[dataNo] = {A3, A0, A1, A2, A5}; // Pro Micros don't have an A4
...
{// 2   3   4   5   6   7   8   9   << address lines
  ...
  {0,0,0,0,KEY_F7,0,0,KEY_F4},                             // A3
  {0,0,0,0,KEY_F8,0,0,KEY_F3},                             // A0
  {0,0,0,KEY_F11,KEY_F9,0,0,KEY_F2},                       // A1
  {KEY_ESC,KEY_RETURN,0,KEY_F12,KEY_F10,0,0,KEY_F1},       // A2
  {0,0,0,0,KEY_F6,0,0,KEY_F5},                             // A5
...
{// 2   3   4   5   6   7   8   9   << address lines
  ...
  {0,0,0,0,KEY_UP_ARROW,0,0,0},                           // A3
  {0,0,0,0,KEY_RIGHT_ARROW,0,0,0},                        // A0
  {0,0,0,0,0,0,0,0},                                      // A1
  {0,0,0,0,KEY_BACKSPACE,0,0,0},                          // A2
  {0,0,0,0,KEY_DOWN_ARROW,0,0,KEY_LEFT_ARROW},            // A5
...
{// 2   3   4   5   6   7   8   9   << address lines
  ...
  {false,false,false,false,false,false,false,false},       // A5
