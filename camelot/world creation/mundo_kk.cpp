...
mundo::mundo(char *file, bool fromTileExtractor)
{
    cout << file << endl;
    screen_orig_x = 0;
    screen_orig_y = 0;
    ...
    cout << " tiles_m_x " << tiles_m_x << " tiles_m_y " << tiles_m_y << endl;
...
mundo::~mundo()
{
	...
	cout << " WARNING!!! : No implementado el destructor de mapa!" << endl;
}
